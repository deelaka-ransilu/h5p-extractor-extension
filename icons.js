// Lucide-style line icons (ISC license). Built with DOMParser, no innerHTML.
const ICON_PATHS = {
  ...
  select: '<path d="m9 11 3 3L22 4"/><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>',
...
function icon(name, size = 15) {
  ...
  s.className = 'ico';
  s.appendChild(makeSvg(name, size));
  return s;
}

// Sets a button's content to [icon] + label
function setBtn(btn, name, label) {
  btn.textContent = '';
  if (name) btn.appendChild(icon(name, 15));
